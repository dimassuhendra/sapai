<footer class="student-footer mt-auto">
    <div class="rounded-4 shadow-lg border-0 p-3 text-center"
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-center px-md-3">
            ...
            <div class="footer-links small">
                ...
                <a href="#" class="text-decoration-none text-white mx-2 opacity-75 hover-opacity-100">Privasi</a>
            </div>
        </div>
    </div>
</footer>
